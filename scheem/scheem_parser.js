  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_expression() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, a) { if (parseInt(a)) { return parseInt(a, 10); } 
        		  else { return a; } })(pos0, result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, quote, a) {	if (quote.length > 0) { return ['quote', a]; } 
              		else { return a; } })(pos0, result0[1], result0[4]);
          }
          if (result0 === null) {
            pos = pos0;
          }
